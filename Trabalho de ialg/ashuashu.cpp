...
void editarProduto(Produto estoque[], int tamanho, int ID) {
    for (int i = 0; i < tamanho; i++) {
        ...
        if (produto.ID == ID) {
            ...
            cin.ignore(); // Limpa o buffer antes de ler o novo nome do produto
            ...
            cin.ignore(); // Limpa o buffer antes de ler a nova data de validade
            cout << "Data de Validade: ";
            for (int i = 0; ','; i++)
            {
                cin >> produto.DataValidade[i];
            }
            

            cin.ignore(); // Limpa o buffer antes de ler a nova categoria
            cout << "Categoria: ";
            for (int i = 0; ','; i++)
            {
                cin >> produto.Categoria[i];
            }
